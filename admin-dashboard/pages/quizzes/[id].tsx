...
import { Flex, Text, Button, Table, Modal, Form, Input, InputNumber, Space, Tag, message, Spin, Tabs, Card, Select } from 'antd';
...
export default function QuizEditorPage() {
    ...
    const saveQuiz = async (updatedQuiz: any) => {
        try {
            await axios.put(`/api/quizzes?id=${id}`, updatedQuiz);
    ...
    if (!quiz) return <Layout><Text>Quiz not found</Text></Layout>;
